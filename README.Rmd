...
You can add the paper you want to download to MarkList and export the BibTex file (In the image below, you can select Other File Formats to access the BibTex format).
![center](man/figures/PIC2.jpg)

Then call the shiny app and upload the data file,then click "load" to start downloading. You can see a progress bar at right corner of the downside.
